							...
							<tr>
								...
								<td class="product-info-master">
									<div class="product-info-box">
										<div class="minibox-img">
											<!-- 이미지 -->
											<img id="img1" src="/upload/${bucketProduct.product.image}"
										...
										<div class="product-size"
											...
											<input class="num-wrap" value="${bucketProduct.product.size}"
												readonly>
											<!-- 여기에 사이즈 EL 표현식 -->
										</div>
										<!-- 상품 페이지 버튼 -->
								...
								<div class="info-align">
									...
									<td>
										<div class="info-align-box">
											<div>
												<input class="all-count"
													value="${bucketProduct.product.price}" readonly>
											</div>
									...
									<td>
										<div class="info-align-box">
											<button type="button" class="btn-util btn-danger"
												onclick="selectProductDelete()">삭제</button>
										</div>
									</td>
